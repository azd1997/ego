...
// NewLoop return a LoopMode.
// Param routines is the number of long-term running go routines(must >0)
...
// Stop stops the long-term running go routines.
// If it's not working, return false; otherwise return true.
